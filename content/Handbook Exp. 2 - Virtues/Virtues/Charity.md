...
0. You can engage in telepathy with any single executioner you have skin to skin contact with.
1. Gain the **Entwine** defiance.
2. At the start of a mission, you can pick an agenda ability from any other party member. For the rest of the mission, you can use this agenda ability as your own.
3. Powers that target ‘self’ can now target any executioner you are **Entwined** with.
