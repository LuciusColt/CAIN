...
#### ☆ **DESECRATE** (*Adjacent, Instant*)

You can forcibly see the memories of corpses, up to a CAT number of humans or executioners by touching them on the eyes. You may ask the corpse(s) three questions total (no matter how many you force), after which the effect ends and they no longer can be interacted with in this way again. It also expires if the hour passes.
