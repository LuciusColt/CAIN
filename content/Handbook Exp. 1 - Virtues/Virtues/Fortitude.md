...
0. You never roll 0d for inflicting harm or violence (always roll at least 1d)
1. Any amount of harm you inflict is instantly fatal to humans.
2. You gain the **Strength** defiance. You can use it safely once a mission. If you use it a second time, when the scene ends, you rip apart from the inside and suffer **instant death**.
