...
0. Once a mission, you can re-roll any action taken in stealth or to avoid notice, taking the second result as final.
1. Gain the **Veil** defiance. You can use it once a mission.
2. Mundane humans always forget you were there if you are out of sight for 77 seconds or more. You cannot turn this ability off.
3. You can use Veil to erase memory for longer periods. See the table below.
