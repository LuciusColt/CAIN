...
2. Executioners **arrive** on the scene. They always arrive in good shape: **full stress**, **no injuries**, **no hooks**, **3 psyche bursts**, **max kit points**. Essentially, each mission is a ‘reset’ for them. The only thing that carries over for them is agendas, strain level, strain marks, and their own abilities, experience, and scrip. 
