...
0. Gain an extra XP trigger: *Did you uphold the dogma of CAIN?*
1. Gain the **Law** defiance. You can use it once a mission.
2. If you executed an anomaly rather than sparing it, then lower strain by 1 after halving it. If you spared an anomaly or failed to execute it, increase strain by 1d3 after halving it instead.
3. You always gain the last effect of **Law** for free (make something specific less hard or risky).
